<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Allimages.aspx.cs" Inherits="Quick_AI.Allimages" %>
...
<div class="dashboard-box margin-top-0 margin-bottom-30 " style="padding: 40px;width: 90%; margin-left: 45px; margin-right: 20px;">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="bi bi-file-earmark"></i>All Images</h3>
                    </div>
                    <div class="content with-padding">
                        <table class="basic-table" style="width:100%">
                            <thead>
                            <tr>
                                <th data-priority="1">All images</th>
                                <th>Content</th>
