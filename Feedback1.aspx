<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Feedback1.aspx.cs" Inherits="Quick_AI.fEEDBACK1" %>
   ...
   <div class="blogmain">
            <div class="goodlook3-blog">
                <div class="row bloghm">
                    <div class="col-6">
                        <h3 style="padding: 15px;">Feedback</h3>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="row blogrow" style="background:white;">
                        <div class="col-md-8">
            ...
            <div class="feed-back-form margin-top-20">
                <form method="post">
                    <div class="submit-field">
                        <h5>Full Name</h5>
                        <input type="text" class="with-border" name="name" required="" style="width:100%;margin-bottom:20px;"/>
                    </div>
                    <div class="submit-field">
                        <h5>Email Address</h5>
                        <input type="text" class="with-border" name="email" required=""style="width:100%;margin-bottom:20px;"/>
                    </div>
                    <div class="submit-field">
                        <h5>Phone Number</h5>
                        <input type="text" class="with-border" name="phone" required=""style="width:100%;margin-bottom:20px;"/>
                    </div>
                    <div class="submit-field">
                        <h5>Subject</h5>
                        <input type="text" class="with-border" name="subject" required=""style="width:100%;margin-bottom:20px;"/>
                    </div>
                    <div class="submit-field">
                    ...
                    <input type="submit" name="Submit" class="button" value="Submit"/>
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="recent-post-widget">
                              ...
                              <div>
                                   <a href="#">
                                       <img src="images/blog.png" style="min-width: 90px;width: 90px;height: 90px;object-fit: cover;border-radius: 4px;"/>
                                   </a>
                              </div>
                                  
                               <div class="recent-post-widget-content">
                                    <h2 ><a href="#" style="text-decoration:none;color: black;font-size: 15px">First Blog</a></h2>
                                    <div class="post-date"style="color: lightgrey;font-weight: 500;font-size: 13px;">
